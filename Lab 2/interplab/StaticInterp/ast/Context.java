...
public class Context {
    ...
    /** Counts the total number of global variables in the program.
     */
    public int numGlobals = 0;

    /** Records the frame size for the current function.
     */
    int frameSize = 0;
     ...
     */
    public Function check(Defn[] defns)
      throws Failure {
        ...
        FunctionEnv mainEnv = FunctionEnv.find("main", functions);
        if (mainEnv==null) {
            throw new Failure("MainDefined");
        }
        Function main = mainEnv.getFunction();
        main.checkMain(this);
        return main;
    }
