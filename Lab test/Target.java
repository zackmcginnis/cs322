...
class NOTop extends Code {
  private Reg reg;
  private Code next;
  NOTop(Reg reg, Code next) {
    this.reg  = reg;
    this.next = next;
  }
...
class Halve extends Code {
  private Reg reg;
  private Code next;
  Halve(Reg reg, Code next) {
    this.reg  = reg;
    this.next = next;
  }

  void print() {
    System.out.println("  Halve " + reg);
    next.print();
  }
...
class Even extends Code {
  private Reg reg;
  private Code next;
  Even(Reg reg, Code next) {
    this.reg  = reg;
    this.next = next;
  }

  void print() {
    System.out.println("  even " + reg);
    next.print();
  }
